...
const GettingStarted = () =>
    <Container>
        ...
        <ul>
            <li>
                <b>Elegant and developer-friendly API</b> - Purify's design decisions are made with developer experience in mind.
                Purify doesn't try to change how you write TypeScript, instead it provides useful tools for making your code easier to
                read and maintain without resolving to hacks or scary type definitions.  
            </li>
            <li>
                <b>Type-safety</b> - While purify can be used in vanilla JavaScript, it's entirely written with TypeScript and type safety in mind.
                While TypeScript does a great job at preventing runtime errors, purify goes a step further and provides utility functions for working
            ...
            <li>
                ...
                but as of right now they don't have reasonable implementations in TypeScript. Purify focuses on being a library that you can
        ...
        On the left sidebar you can find all of purify's contents, each page contains a guide on how to start using it. <br />
